...
1. Apple has the highest churn rate (7.17%)

This means:

Apple users change brands more often than Samsung and Google users.
...
Battery life dissatisfaction

Switching to Android for flexibility

Camera expectations not met



2. Samsung is close behind (7.09%)

Very similar to Apple — Samsung users also churn at about the same rate.
...
Perception of fast battery ageing



3. Google has the lowest churn rate (6.68%)

This suggests:

Google Pixel users show slightly stronger loyalty

Pixel users who join often stick with the brand

Strong camera + software experience may improve retention




Brand	Loyalty	Meaning
Google	⭐⭐⭐⭐⭐	Most loyal customers
Samsung	⭐⭐⭐⭐	Medium-high loyalty
Apple	⭐⭐⭐	Slightly lower loyalty
